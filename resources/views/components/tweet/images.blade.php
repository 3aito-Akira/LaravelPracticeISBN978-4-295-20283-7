    ...
    <div class="flex justify-center -mx-2">
        ...
        <div class="w-1/6 px-2 mt-5">
            <div class="bg-gray-400">
                <a @click="$dispatch('img-modal', {  imgModalSrc: '{{ asset('storage/images/' . $image->pathName)  }}' })" class="cursor-pointer">
                    <img alt="{{ $image->pathName }}" class="object-fit w-full" src="{{ asset('storage/images/' . $image->pathName) }}">
                </a>
            </div>
        </div>
        @endforeach
